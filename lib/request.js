...
const wmt_marketplace_auth_canada_1 = require("wmt-marketplace-auth-canada");
...
function execute(request) {
     ...
     */
    let headers = new wmt_marketplace_auth_canada_1.Authenticate.Custom;
     ...
     */
    let signedHeaders = wmt_marketplace_auth_canada_1.Authenticate.sign(headers, {
